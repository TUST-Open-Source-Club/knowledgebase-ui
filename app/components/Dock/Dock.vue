...
<script lang="ts">
  ...
  const DockLabel = defineComponent({
    ...
    render() {
      const labelStyle: CSSProperties = {
        ...
        border: '1px solid var(--dock-label-border, #222)',
        backgroundColor: 'var(--dock-label-background, #222)',
  ...
  const DockItem = defineComponent({
    ...
    render() {
      const icon =
        typeof this.item.icon === 'function' ? (this.item.icon as () => unknown)() : this.item.icon;
      const label =
      ...
      const itemStyle: CSSProperties = {
        ...
        justifyContent: 'center',
        borderRadius: '10px',
        backgroundColor: 'var(--dock-item-background, #120F17)',
        border: '1px solid var(--dock-item-border, #222)',
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const panelStyle = computed<CSSProperties>(() => ({
        ...
        gap: '1rem',
        borderRadius: '1rem',
        backgroundColor: 'var(--dock-background, #120F17)',
        border: '1px solid var(--dock-border, #222)',
